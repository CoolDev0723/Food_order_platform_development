...
<div class="col-md-12">
    <div class="card">
        <div class="card-body">
            ...
            <button type="submit" class="btn btn-success btn-labeled btn-labeled-left btn-lg" id="manageRestaurants">
                ...
                <div class="col-lg-12">
                    <form action="{{ route('admin.updateManageRestaurantOwnersRestaurants') }}" method="POST">
                        ...
                        <div class="text-right mb-4">
                            <button type="button" class="btn btn-success btn-labeled btn-labeled-left btn-sm" id="checkAll" data-popup="tooltip" title="Double Click to Check All" data-placement="left">
                            <b><i class="icon-check ml-1"></i></b>
                            Check All
                            </button>
                            <button type="button" class="btn btn-success btn-labeled btn-labeled-left btn-sm" id="unCheckAll" data-popup="tooltip" title="Double Click to Un-check All" data-placement="top">
